...
def parse_cli_args():
    ...
    parser.add_argument("--num_workers", required=False, type=int, default=4, help="Number of data loading workers")
    parser.add_argument("--weight_decay", required=False, help="Optional: override weight_decay")
    parser.add_argument("--gradient_accumulation_steps", required=False, type=int, help="Gradient accumulation steps")
    parser.add_argument("--grad_clip", required=False, type=float, default=1.0, help="Gradient clipping norm")
    parser.add_argument("--precision", required=False, choices=["fp16", "bf16", "fp32"], help="Precision for training")
    parser.add_argument("--logging_steps", required=False, type=int, default=100, help="Log every X steps")
    parser.add_argument("--eval_strategy", required=False, type=str, default="steps", help="Evaluation strategy: 'steps' or 'epoch'")
    parser.add_argument("--eval_steps", required=False, type=int, default=500, help="Evaluate every X steps")
    parser.add_argument("--save_total_limit", required=False, type=int, default=3, help="Total number of checkpoints to keep")
    parser.add_argument("--save_strategy", required=False, type=str, default="steps", help="Save strategy: 'steps' or 'epoch'")
